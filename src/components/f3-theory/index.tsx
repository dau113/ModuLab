...
import { BookOpen, Award, FileCheck, Layers } from 'lucide-react';
          ...
          {module.id === 'lab-1' ? (
            <>
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl">
                ...
                <p className="text-[clamp(13px,0.9vw,15.5px)] leading-relaxed text-slate-600 mb-3">
                ...
                <div className="mt-3 grid grid-cols-3 gap-2 text-center text-[clamp(13px,0.9vw,15.5px)]">
