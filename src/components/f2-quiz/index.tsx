/**
 * F2 — Khởi động: trắc nghiệm ôn tập nhanh, lấy câu hỏi từ ngân hàng 75 câu.
 * Có đồng hồ đếm ngược, chuỗi trả lời đúng, pháo hoa chúc mừng và hình minh hoạ
 * cho những câu hỏi có nhắc tới hình vẽ.
 */
...
export const QuizGame: React.FC<QuizGameProps> = ({ userRole, onFinishQuiz, extraQuestions }) => {
  ...
  const hasArt = !!QUESTION_ART[current?.id ?? ''];
